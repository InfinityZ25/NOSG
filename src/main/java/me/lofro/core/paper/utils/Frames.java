...
public class Frames {
    ...
    /**
     * Function to obtain the subsequent frames of a complete interval of Unicode
     * characters.
     * 
     * @param from  The starting Unicode character from EOOO
     * @param until The ending Unicode character from (EOOO + from)
     * @return A list of Unicode characters
     */
    public static List<Character> getFramesChars(int from, int until) {
     ...
     * @param until Final Integer
     * @return A list of unicode characters in the base 10 space.
     */
